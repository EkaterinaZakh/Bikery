  ...
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          name: 'Шлем CockHelmet THOC',
          desc: 'Главные преимущества закрытого шлема - простота в использовании и комфорт. Закрытый шлем для мотоцикла из поликарбоната идеально подходит любителям неспешной езды. Обладает наилучшими характеристиками вентиляции, что очень актуально в жару.',
          price: 14500,
          image: 'maska.jpeg',
          categoryId: 2,
          createdAt: new Date(),
