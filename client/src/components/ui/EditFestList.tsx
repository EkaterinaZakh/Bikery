...
export default function EditFestList({ onSubmit, onCancel }: EditListProps): JSX.Element {
  ...
  return (
    <Box as="form" sx={boxStyle} noValidate autoComplete="off" onSubmit={submitHandler}>
