...
export default function MainPage(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      >
        <Typography variant="body2" sx={{ width: '50%', fontSize: '18px', marginRight: '50px' }}>
          <strong>Bikery</strong> - портал, где свобода не просто слово, а образ жизни. Здесь каждый
          может почувствовать настоящую скорость, ощутить дух движения и стать частью нашего
          сильного сообщества байкеров. Мы поощряем бунтарство против обыденности и вместе создаем
